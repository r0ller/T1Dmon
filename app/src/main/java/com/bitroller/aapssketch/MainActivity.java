...
import com.bitroller.aapssketch.R;
...
public class MainActivity extends Activity {
    ...
    UsbDevice device;
    UsbManager manager;
    private static final String ACTION_USB_PERMISSION = "com.bitroller.aapssketch.USB_PERMISSION";
...
//        SharedPreferences settings=getSharedPreferences("com.bitroller.aapssketch",MODE_PRIVATE);
//        if(settings!=null){
...
//        }
        ...
        Toast.makeText(this,deviceList.toString(),Toast.LENGTH_SHORT).show();
